<button id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation"
    class="inline-flex items-center rounded-lg bg-gray-200 px-5 text-center text-sm focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-gray-700 dark:focus:ring-blue-800"
