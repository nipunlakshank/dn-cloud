<div class="flex items-start gap-2.5" {{ $attributes }}>
    ...
    <div class="flex flex-col gap-1">
        ...
        <div
            class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-white rounded-e-xl rounded-es-xl dark:bg-gray-700">
            ...
            <div class="flex justify-end items-center">
                <button
                    ...
                    <svg class="w-3 h-3 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 16 18">
