...
<img class="h-8 w-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg"
   ...
   <div class="flex flex-col gap-1">
      ...
      <div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-50 rounded-e-xl rounded-es-xl dark:bg-gray-700">
         <div class="flex items-start bg-white dark:bg-gray-600 rounded-xl p-2">
            <div class="me-2">
