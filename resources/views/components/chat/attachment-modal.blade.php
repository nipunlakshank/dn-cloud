                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input required multiple type="file" accept=".pdf, .doc,.docx .xls, .xlsx, .csv" name="chat-attachment-document" id="chat-attachment-document" class="hidden">
                        </div>
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input multiple type="file" accept=".png, .jpg, .jpeg" name="chat-attachment-report-image" id="chat-attachment-report-image" class="hidden">
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <input required multiple type="file" accept=".pdf, .doc,.docx .xls, .xlsx, .csv" name="chat-attachment-report-document" id="chat-attachment-report-document" class="hidden">
                        </div>
