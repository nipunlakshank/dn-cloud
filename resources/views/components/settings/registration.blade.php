...
<div
    x-data="{
        target:document.getElementById('user-registration-modal'),
        options:{
    ...
    x-init="userRegistrationModal = new Modal(target,options,instanceOptions)"
    x-on:open-registration-modal.window="userRegistrationModal.show()"
    id="user-registration-modal"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button
                    type="button"
                    x-on:click="userRegistrationModal.hide()"
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" method="POST" action="register">
                @csrf
                ...
                <button x-on:click="userRegistrationModal.hide()" type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Register
                </button>
            </form>
        </div>
