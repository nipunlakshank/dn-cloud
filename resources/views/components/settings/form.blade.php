<div class="align-items-center pt-[40px] flex w-full justify-center h-screen">
    <form class="flex flex-col h-screen">
        <div class="mb-6 grid gap-6 md:grid-cols-2">
            <div>
                <label for="first_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">First
                    name</label>
            ...
            <div>
                <label for="website" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Website
                    URL</label>
            ...
            <div>
                <label for="visitors" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Unique
        ...
        <div class="mb-6">
            <label for="confirm_password" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Confirm
                password</label>
        ...
        <button type="submit"
            class="w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
    </form>
</div>
