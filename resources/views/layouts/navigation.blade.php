                    ...
                    <div>
                        <button type="button"
                            ...
                            @if (Auth()->user()->avatar != null)
                                <picture class="h-8 w-8 overflow-hidden rounded-full">
                                    <img src="{{ route('profile.avatar', Auth()->user()->avatar) }}"
                                        alt="Profile Image">
                                </picture>
                            @else
                                <svg class="h-9 w-9 overflow-hidden rounded-full" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
