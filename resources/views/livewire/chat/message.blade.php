<div
    ...
    <div class="relative flex w-fit max-w-[80%] flex-col gap-1 lg:max-w-md">
        @if ($inAGroup && !$isOwner)
        ...
        <div
            ...
            <div class="flex select-none items-end justify-end gap-1" dir="ltr"
                ...
                <!-- Noted Batch -->
                <div class="flex w-fit absolute right-[-1.5rem] bottom-[-1rem] px-2 py-2 rounded-full bg-white dark:bg-gray-700">
                    <img width="24" height="24" src="https://img.icons8.com/color/50/verified-badge.png" alt="verified-badge" />
                </div>
    ...
    <div id="messageOptions-{{ $message->id }}" dir="ltr"
        ...
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
            ...
            @if (!$isOwner)
            <li class="border-b-2 border-gray-200 dark:border-gray-500">
                <button wire:click="markAsNoted()" type="button"
                    class="px-4 py-2 inline-flex gap-3 cursor-pointer hover:bg-gray-100 active:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white dark:active:bg-gray-500">
                    Mark as Noted
                    <img width="24" height="24" src="https://img.icons8.com/color/50/verified-badge.png" alt="verified-badge" />
                </button>
            </li>
