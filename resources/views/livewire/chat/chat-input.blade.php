<div class="w-full">
    ...
    <form wire:submit.prevent="sendMessage">
        ...
        <div class="flex items-center rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-700">
            ...
            <button id="attachment-menu-button" data-dropdown-toggle="attachment-menu" type="button" class="inline-flex cursor-pointer justify-center rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
