...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/nipun/dev/Sites/dncloud/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/nipun/dev/Sites/dncloud/public/storage','logging.default',
...
'mail.mailers.smtp.scheme','mail.mailers.smtp.url','mail.mailers.smtp.host','mail.mailers.smtp.port','mail.mailers.smtp.encryption',
...
'livewire.update','livewire.upload-file','livewire.preview-file','index','about-us','contact','profile.edit',
'profile.update','profile.destroy','dashboard','wallet-status','user-status',
'chat','chat','reports','login',
'password.request','password.email','password.reset','password.store','register',
'profile.update','profile.avatar','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','logout','dev.login',
'storage.local',);
        registerArgumentsSet('views', 
'about-us','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status','components.chat',
'components.chat.attachment-menu','components.chat.attachment-modal','components.chat.bubble','components.chat.bubble-file','components.chat.bubble-img',
'components.chat.bubble-img-multi','components.chat.chat-image-viewer','components.chat.dropdown','components.chat.list-item','components.chat.topbar',
'components.danger-button','components.dashboard-table','components.dropdown','components.dropdown-link','components.footer',
'components.input-error','components.input-label','components.layouts.app','components.modal','components.nav',
'components.nav-link','components.navbar','components.primary-button','components.responsive-nav-link','components.search-bar',
'components.secondary-button','components.settings.add-group','components.settings.logout','components.settings.navigation','components.settings.new-chat',
'components.settings.profile','components.settings.registration','components.text-input','components.users-table','components.wallets.list',
'components.wallets.list-item','contact','dashboard','dashboard-default','layouts.app',
'layouts.guest','layouts.navigation','livewire.chat.chat-card','livewire.chat.chat-header','livewire.chat.chat-input',
'livewire.chat.chat-list','livewire.chat.chat-messages','livewire.chat.chat-sidebar','livewire.chat.index','livewire.chat.message',
'livewire.modals.add-group','livewire.modals.new-chat','livewire.reports.main','livewire.reports.wallet-list','login',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','signin',
'wallets','welcome','welcome-old','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
